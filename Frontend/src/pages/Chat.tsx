...
const MiniAgentPanel = lazy(() => import("@/components/chat/MiniAgentPanel").then(m => ({ default: m.MiniAgentPanel })));
const HighlightsPanel = lazy(() => import("@/components/chat/HighlightsPanel").then(m => ({ default: m.HighlightsPanel })));
